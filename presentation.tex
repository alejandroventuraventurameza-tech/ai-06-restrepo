...
\begin{enumerate}\setlength\itemsep{2pt}
  \item \textbf{Modelo en frío} (Claude aislado): acierta en la ambigüedad del salario; omite los regímenes, la condición exacta y el papel de $K$.
  \item \textbf{Agente Lean (E2)}: copió mal $B$; compilaba, pero el dominio se reducía a $\tilde B=1$.
  \item \textbf{Agente Lean (E3)}: vio el síntoma 3 veces y parchó el cuantificador; nunca detectó la dirección.
  \item \textbf{Claude (E1)}: dejó un \texttt{.git/index.lock} que bloqueaba commits.
